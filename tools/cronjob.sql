...
UPDATE Config SET Value='/data/imagingData/' WHERE ConfigID=(SELECT ID FROM ConfigSettings WHERE Name='data');
UPDATE Config SET Value='/data/imagingData/' WHERE ConfigID=(SELECT ID FROM ConfigSettings WHERE Name='mincPath');
UPDATE Config SET Value='/data/imagingData/' WHERE ConfigID=(SELECT ID FROM ConfigSettings WHERE Name='imagePath');
